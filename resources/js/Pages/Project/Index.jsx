...
export default function Index({ auth, projects, queryParams = null, success }) {
    ...
    const searchFieldChanged = (name, value) => {
        const newQueryParams = { ...queryParams }; // ✅ Create a new object
        if (value) {
                                ...
                                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400 rtl:text-right">
                                    ...
                                    <tbody>
                                        {projects.data.map((project) => (
                                            ...
                                            <tr
                                                key={project.id} // Added key prop to avoid React warning
                                            ...
                                            >
                                                ...
                                                <td className="px-3 py-2">
                                                    <span 
                                                        className={`px-2 py-1 rounded text-white ${PROJECT_STATUS_CLASS_MAP[project.status] || "bg-gray-500"}`}
                                                    >
                                                        {PROJECT_STATUS_TEXT_MAP[project.status] || "Unknown"}
                                                    </span>
                                                </td>
